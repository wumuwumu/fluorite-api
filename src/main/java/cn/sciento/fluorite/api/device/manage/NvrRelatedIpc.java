 ...
 * @time 12:32 PM
 */
public class NvrRelatedIpc extends AbstractAPI{
    private String deviceSerial;
    private String ipcSerial;
    private HttpPostMethod httpPostMethod;

    public NvrRelatedIpc(String url, String accessToken, String deviceSerial,String ipcSerial,Integer channelNo) {
        this.url = url;
