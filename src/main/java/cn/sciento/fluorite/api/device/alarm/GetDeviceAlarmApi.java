...
public class GetDeviceAlarmApi extends AbstractAPI {
    ...
    public GetDeviceAlarmApi() {
        this.url = ServerConstant.GET_DEVICE_ALARM_LIST;
    }
    ...
    public static final class Builder {
        ...
        public GetDeviceAlarmApi build() {
            GetDeviceAlarmApi getAlarmListApi = new GetDeviceAlarmApi();
